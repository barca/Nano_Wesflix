...
the_philadelphia_story = movie(
	"The Philadelphia Story","July 18", poster_url, description, trailer_url,
	"","George Cukor", "112","Kathrine Hepburn", "Cary Grant"
	)
desc = (
...
futurama = movie(
	"Futurama","July 19", poster_url,desc, trailer_url, big_pic,
	"Peter Avanzino","89", "Billy West", "Katey Segal"
	)
description = (
	"Andy Dufresne (Tim Robbins) is sentenced to two consecutive "
...
shawshank_redemption = movie(
	"Shawshank Redemption","July 20", poster_url, description, trailer_url,
	 big_pic, "Frank Darabont", "142", "Tim Robbins", "Morgan Freedman"
	)
description = (
	"the park is open. However, disaster strikes again, "
...
jurrassic_world = movie(
	"Jurrassic World", "July 21", poster_url,
...
big_pic = ""
dirty_harry = movie(
	"Dirty Harry", "July 22", poster_url, desc,trailer_url,
	 big_pic, "Don Siegel", "103", "Clint Eastwood", "Andrew Robbinson"	
	)
description = (
	"Beginning in 2005, Palestinian Emad Burnet records his "
...
five_broken_cameras = movie(
	"Five Broken Cameras","July 22", poster_url, description, trailer_url,
	big_pic, "Ehmad Burnat", "94", "Ehmad Bernat", "Soraya Burnat"
	
		)
description = (
	"There is a secret at a Catholic school, a nun, Merryl "
...
doubt = movie(
	"Doubt","July 23", poster_url, description, trailer_url,
...
description = (
	"Harrison Ford, Replicant Hunter. His assignment: eliminate "
...
blade_runner = movie(
	"Blade Runner", "July 24", poster_url, description,
